...
namespace openiddict_angular2.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Authorize()
        {
            ...
            var request2 = HttpContext.GetOpenIdConnectRequest();
            ...
            ticket.SetResources(request2.GetResources());
            ticket.SetScopes(request2.GetScopes());

            // Returning a SignInResult will ask OpenIddict to issue the appropriate access/identity tokens.
            return SignIn(ticket.Principal, ticket.Properties, ticket.AuthenticationScheme);
            /// remove code till here - refer above comments first.
        }
