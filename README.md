...
## ASP.NET Core samples
  ...
  - [Smallprogram](samples/Smallprogram): examples of Blazor Server Client, Blazor WASM Client, API, and OpeniddictServer deployed independently using Authorization Code.
